...
function initStyle() {
    ...
    document.getElementById('titleHeader').innerText = 'Chúc mừng sinh nhật quốc mẫu :)) 🕯️';
    document.getElementById('contentHeader').innerText = '🌹💐 Chúc quốc mẫu sinh nhật vui vẻ, luôn xinh đẹp, học giỏi và làm được nhưng điều mình mong ước ☘️ All the best to you !';
    loadSong();
}
...
window.onload = async function() {
    ...
    if (!id) {
        ...
        try {
            ...
            document.getElementById('titleHeader').innerText = data?.tieuDe || 'Chúc mừng sinh nhật quốc mẫu :)) 🕯️';
            document.getElementById('contentHeader').innerText = data?.message || '🌹💐 Chúc quốc mẫu sinh nhật vui vẻ, luôn xinh đẹp, học giỏi và làm được nhưng điều mình mong ước ☘️';
